      ...
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.3fr_0.7fr_0.7fr_1fr]">
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <a href="https://instagram.com/vellio.fr" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/12 bg-white/5 text-white/45 transition-colors hover:border-brand-accent/50 hover:text-brand-accent" aria-label="Instagram Vellio">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="https://x.com/VellioFR" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/12 bg-white/5 text-white/45 transition-colors hover:border-brand-accent/50 hover:text-brand-accent" aria-label="X / Twitter Vellio">
              <Twitter className="h-4 w-4" />
            </a>
            <a href="https://tiktok.com/@vellio.fr" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/12 bg-white/5 text-white/45 transition-colors hover:border-brand-accent/50 hover:text-brand-accent" aria-label="TikTok Vellio">
              <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.22 8.22 0 0 0 4.77 1.52V6.76a4.85 4.85 0 0 1-1-.07z"/></svg>
            </a>
          </div>
        </div>
