...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/gadgets-tech-tendance`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.85 },
    { url: `${BASE}/accessoires-sport-maison`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.83 },
    { url: `${BASE}/cuisine-equipement-maison`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.82 },
